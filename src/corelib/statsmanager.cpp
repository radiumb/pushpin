...
public:
		...
		reportTimer(0)
	{
		...
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcNet, "number_of_group_eth/net", "counter", "Number of ws JSON-RPC eth/net method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcWeb3, "number_of_group_eth/web3", "counter", "Number of ws JSON-RPC eth/web3 method group");
