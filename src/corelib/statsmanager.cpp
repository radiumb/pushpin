...
public:
		...
		reportTimer(0)
	{
		...
		prometheusMetrics += PrometheusMetric(PrometheusMetric::RequestReceived, "request_received", "cstatus", "Number of requests received");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::ConnectionConnected, "connection_connected", "cstatus", "Number of concurrent connections");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::ConnectionMinute, "connection_minute", "cstatus", "Number of minutes clients have been connected");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::MessageReceived, "message_received", "cstatus", "Number of messages received by the publish API");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::MessageSent,"message_sent", "cstatus", "Number of messages sent to clients");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRequestReceived, "number_of_ws_request_received", "cstatus", "Number of ws requests received");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numWsConnect, "number_of_ws_connection_received", "cstatus", "Number of ws sconcurrent connections");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numMessageSent, "number_of_ws_message_sent", "cstatus", "Number of ws message sent");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcAuthor, "number_of_group_author", "cstatus", "Number of ws JSON-RPC author method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcBabe, "number_of_group_babe", "cstatus", "Number of ws JSON-RPC babe method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcBeefy, "number_of_group_beefy", "cstatus", "Number of ws JSON-RPC beefy method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcChain, "number_of_group_chain", "cstatus", "Number of ws JSON-RPC chain method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcChildState, "number_of_group_childstate", "cstatus", "Number of ws JSON-RPC childstate method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcContracts, "number_of_group_contracts", "cstatus", "Number of ws JSON-RPC contracts method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcDev, "number_of_group_dev", "cstatus", "Number of ws JSON-RPC dev method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcEngine, "number_of_group_engine", "cstatus", "Number of ws JSON-RPC engine method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcEth, "number_of_group_eth", "cstatus", "Number of ws JSON-RPC eth method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcNet, "number_of_group_eth/net", "cstatus", "Number of ws JSON-RPC eth/net method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcWeb3, "number_of_group_eth/web3", "cstatus", "Number of ws JSON-RPC eth/web3 method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcGrandpa, "number_of_group_grandpa", "cstatus", "Number of ws JSON-RPC grandpa method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcMmr, "number_of_group_mmr", "cstatus", "Number of ws JSON-RPC mmr method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcOffchain, "number_of_group_offchain", "cstatus", "Number of ws JSON-RPC offchain method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcPayment, "number_of_group_paymenet", "cstatus", "Number of ws JSON-RPC payment method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcRpc, "number_of_group_rpc", "cstatus", "Number of ws JSON-RPC rpc method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcState, "number_of_group_state", "cstatus", "Number of ws JSON-RPC state method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcSyncstate, "number_of_group_syncstate", "cstatus", "Number of ws JSON-RPC syncstate method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcSystem, "number_of_group_system", "cstatus", "Number of ws JSON-RPC system method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcSubscribe, "number_of_group_subscribe", "cstatus", "Number of ws JSON-RPC subscribe method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numCacheInsert, "number_of_cache_insert", "cstatus", "Number of ws Cache insert event");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numCacheHit, "number_of_cache_hit", "cstatus", "Number of ws Cache hit event");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numCacheLookup, "number_of_cache_lookup", "cstatus", "Number of ws Cache lookup event");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numCacheExpiry, "number_of_cache_expiry", "cstatus", "Number of ws Cache expiry event");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRequestMultiPart, "number_of_cache_request_multi_part", "cstatus", "Number of ws Cache multi-part request");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numSubscriptionInsert, "number_of_subscription_insert", "cstatus", "Number of ws Subscripion insert event");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numSubscriptionHit, "number_of_subscription_hit", "cstatus", "Number of ws Subscripion hit event");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numSubscriptionLookup, "number_of_subscription_lookup", "cstatus", "Number of ws Subscripion lookup event");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numSubscriptionExpiry, "number_of_subscription_expiry", "cstatus", "Number of ws Subscripion expiry event");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numResponseMultiPart, "number_of_cache_response_multi_part", "cstatus", "Number of ws Subscripion multi-part response");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numCacheItem, "number_of_cache_item", "cstatus", "Number of ws Cache items");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numSubscriptionItem, "number_of_subscription_item", "cstatus", "Number of ws Subscription items");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numAutoRefreshItem, "number_of_cache_auto_refresh_item", "cstatus", "Number of ws Auto-Refresh items");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numAREItemCount, "number_of_cache_auto_refresh_exception_item", "cstatus", "Number of ws Auto-Refresh Exception items");
		// Group count add
		...
		for (int i = 0; i < gCnt; i++)
		{
			...
			PrometheusMetric::Type groupType = (PrometheusMetric::Type)(PrometheusMetric::numAREItemCount+i+1);
			prometheusMetrics += PrometheusMetric(groupType, groupName, "cstatus", groupName);	
		}
		shmdt(shm_str);
...
private slots:
	...
	void prometheus_requestReady()
	{
		...
		foreach(const PrometheusMetric &m, prometheusMetrics)
		{
			...
			long numRpcRpc = 0, numRpcState = 0, numRpcSyncstate = 0, numRpcSystem = 0, numRpcSubscribe = 0;
			long numCacheInsert = 0, numCacheHit = 0, numCacheLookup = 0, numCacheExpiry = 0, numRequestMultiPart = 0;
			long numSubscriptionInsert = 0, numSubscriptionHit = 0, numSubscriptionLookup = 0, numSubscriptionExpiry = 0, numResponseMultiPart = 0;
			...
			numRpcChain = *(long *)&str[32];
			numRpcChildState = *(long *)&str[36];
			numRpcContracts = *(long *)&str[40];
			numRpcDev = *(long *)&str[44];
			numRpcEngine = *(long *)&str[48];
			numRpcEth = *(long *)&str[52];
			numRpcNet = *(long *)&str[56];
			numRpcWeb3 = *(long *)&str[60];
			numRpcGrandpa = *(long *)&str[64];
			numRpcMmr = *(long *)&str[68];
			numRpcOffchain = *(long *)&str[72];
			numRpcPayment = *(long *)&str[76];
			numRpcRpc = *(long *)&str[80];
			numRpcState = *(long *)&str[84];
			numRpcSyncstate = *(long *)&str[88];
			numRpcSystem = *(long *)&str[92];
			numRpcSubscribe = *(long *)&str[96];
			numCacheInsert = *(long *)&str[100];
			numCacheHit = *(long *)&str[104];
			numCacheLookup = *(long *)&str[108];
			numCacheExpiry = *(long *)&str[112];
			numRequestMultiPart = *(long *)&str[116];
			numSubscriptionInsert = *(long *)&str[120];
			numSubscriptionHit = *(long *)&str[124];
			numSubscriptionLookup = *(long *)&str[128];
			numSubscriptionExpiry = *(long *)&str[132];
			numResponseMultiPart = *(long *)&str[136];
			numCacheItem = *(long *)&str[140];
			numSubscriptionItem = *(long *)&str[144];
			...
			switch(m.mtype)
			{
				...
				case PrometheusMetric::numRpcChain: value = QVariant((int)numRpcChain); break;
				case PrometheusMetric::numRpcChildState: value = QVariant((int)numRpcChildState); break;
				case PrometheusMetric::numRpcContracts: value = QVariant((int)numRpcContracts); break;
				case PrometheusMetric::numRpcDev: value = QVariant((int)numRpcDev); break;
				case PrometheusMetric::numRpcEngine: value = QVariant((int)numRpcEngine); break;
				case PrometheusMetric::numRpcEth: value = QVariant((int)numRpcEth); break;
				case PrometheusMetric::numRpcNet: value = QVariant((int)numRpcNet); break;
				case PrometheusMetric::numRpcWeb3: value = QVariant((int)numRpcWeb3); break;
				case PrometheusMetric::numRpcGrandpa: value = QVariant((int)numRpcGrandpa); break;
				case PrometheusMetric::numRpcMmr: value = QVariant((int)numRpcMmr); break;
				case PrometheusMetric::numRpcOffchain: value = QVariant((int)numRpcOffchain); break;
				case PrometheusMetric::numRpcPayment: value = QVariant((int)numRpcPayment); break;
				case PrometheusMetric::numRpcRpc: value = QVariant((int)numRpcRpc); break;
				case PrometheusMetric::numRpcState: value = QVariant((int)numRpcState); break;
				case PrometheusMetric::numRpcSyncstate: value = QVariant((int)numRpcSyncstate); break;
				case PrometheusMetric::numRpcSystem: value = QVariant((int)numRpcSystem); break;
				case PrometheusMetric::numRpcSubscribe: value = QVariant((int)numRpcSubscribe); break;
				case PrometheusMetric::numCacheInsert: value = QVariant((int)numCacheInsert); break;
				case PrometheusMetric::numCacheHit: value = QVariant((int)numCacheHit); break;
				case PrometheusMetric::numCacheLookup: value = QVariant((int)numCacheLookup); break;
				case PrometheusMetric::numCacheExpiry: value = QVariant((int)numCacheExpiry); break;
				case PrometheusMetric::numRequestMultiPart: value = QVariant((int)numRequestMultiPart); break;
				case PrometheusMetric::numSubscriptionInsert: value = QVariant((int)numSubscriptionInsert); break;
				case PrometheusMetric::numSubscriptionHit: value = QVariant((int)numSubscriptionHit); break;
				case PrometheusMetric::numSubscriptionLookup: value = QVariant((int)numSubscriptionLookup); break;
				case PrometheusMetric::numSubscriptionExpiry: value = QVariant((int)numSubscriptionExpiry); break;
				case PrometheusMetric::numResponseMultiPart: value = QVariant((int)numResponseMultiPart); break;
				case PrometheusMetric::numCacheItem: value = QVariant((int)numCacheItem); break;
				case PrometheusMetric::numSubscriptionItem: value = QVariant((int)numSubscriptionItem); break;
				case PrometheusMetric::numAutoRefreshItem: value = QVariant((int)numAutoRefreshItem); break;
				case PrometheusMetric::numAREItemCount: value = QVariant((int)numAREItemCount); break;
				...
				default: {
					...
					for (int i = 0; i < gCnt; i++)
					{
						...
						shm_read_count += 20*mCnt;	
						if (m.mtype == (PrometheusMetric::numAREItemCount+i+1))
						{
