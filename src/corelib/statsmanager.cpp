...
public:
		...
		reportTimer(0)
	{
		...
		prometheusMetrics += PrometheusMetric(PrometheusMetric::RequestReceived, "request_received", "gauge", "Number of requests received");
		...
		prometheusMetrics += PrometheusMetric(PrometheusMetric::ConnectionMinute, "connection_minute", "gauge", "Number of minutes clients have been connected");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::MessageReceived, "message_received", "gauge", "Number of messages received by the publish API");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::MessageSent,"message_sent", "gauge", "Number of messages sent to clients");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRequestReceived, "number_of_ws_request_received", "gauge", "Number of ws requests received");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numWsConnect, "number_of_ws_connection_received", "gauge", "Number of ws sconcurrent connections");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numMessageSent, "number_of_ws_message_sent", "gauge", "Number of ws message sent");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcAuthor, "number_of_group_author", "gauge", "Number of ws JSON-RPC author method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcBabe, "number_of_group_babe", "gauge", "Number of ws JSON-RPC babe method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcBeefy, "number_of_group_beefy", "gauge", "Number of ws JSON-RPC beefy method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcChain, "number_of_group_chain", "gauge", "Number of ws JSON-RPC chain method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcChildState, "number_of_group_childstate", "gauge", "Number of ws JSON-RPC childstate method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcContracts, "number_of_group_contracts", "gauge", "Number of ws JSON-RPC contracts method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcDev, "number_of_group_dev", "gauge", "Number of ws JSON-RPC dev method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcEngine, "number_of_group_engine", "gauge", "Number of ws JSON-RPC engine method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcEth, "number_of_group_eth", "gauge", "Number of ws JSON-RPC eth method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcNet, "number_of_group_eth/net", "gauge", "Number of ws JSON-RPC eth/net method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcWeb3, "number_of_group_eth/web3", "gauge", "Number of ws JSON-RPC eth/web3 method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcGrandpa, "number_of_group_grandpa", "gauge", "Number of ws JSON-RPC grandpa method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcMmr, "number_of_group_mmr", "gauge", "Number of ws JSON-RPC mmr method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcOffchain, "number_of_group_offchain", "gauge", "Number of ws JSON-RPC offchain method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcPayment, "number_of_group_paymenet", "gauge", "Number of ws JSON-RPC payment method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcRpc, "number_of_group_rpc", "gauge", "Number of ws JSON-RPC rpc method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcState, "number_of_group_state", "gauge", "Number of ws JSON-RPC state method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcSyncstate, "number_of_group_syncstate", "gauge", "Number of ws JSON-RPC syncstate method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcSystem, "number_of_group_system", "gauge", "Number of ws JSON-RPC system method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcSubscribe, "number_of_group_subscribe", "gauge", "Number of ws JSON-RPC subscribe method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numCacheInsert, "number_of_cache_insert", "gauge", "Number of ws Cache insert event");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numCacheHit, "number_of_cache_hit", "gauge", "Number of ws Cache hit event");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numCacheLookup, "number_of_cache_lookup", "gauge", "Number of ws Cache lookup event");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numCacheExpiry, "number_of_cache_expiry", "gauge", "Number of ws Cache expiry event");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRequestMultiPart, "number_of_cache_request_multi_part", "gauge", "Number of ws Cache multi-part request");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numSubscriptionInsert, "number_of_subscription_insert", "gauge", "Number of ws Subscripion insert event");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numSubscriptionHit, "number_of_subscription_hit", "gauge", "Number of ws Subscripion hit event");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numSubscriptionLookup, "number_of_subscription_lookup", "gauge", "Number of ws Subscripion lookup event");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numSubscriptionExpiry, "number_of_subscription_expiry", "gauge", "Number of ws Subscripion expiry event");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numResponseMultiPart, "number_of_cache_response_multi_part", "gauge", "Number of ws Subscripion multi-part response");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numCacheItem, "number_of_cache_item", "gauge", "Number of ws Cache items");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numSubscriptionItem, "number_of_subscription_item", "gauge", "Number of ws Subscription items");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numAutoRefreshItem, "number_of_cache_auto_refresh_item", "gauge", "Number of ws Auto-Refresh items");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numAREItemCount, "number_of_cache_auto_refresh_exception_item", "gauge", "Number of ws Auto-Refresh Exception items");
		// Group count add
		...
		for (int i = 0; i < gCnt; i++)
		{
			...
			prometheusMetrics += PrometheusMetric(groupType, groupName, "gauge", groupName);	
		}
		shmdt(shm_str);
