...
public:
		...
		reportTimer(0)
	{
		...
		prometheusMetrics += PrometheusMetric(PrometheusMetric::RequestReceived, "request_received", "gauges", "Number of requests received");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::ConnectionConnected, "connection_connected", "gauges", "Number of concurrent connections");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::ConnectionMinute, "connection_minute", "gauges", "Number of minutes clients have been connected");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::MessageReceived, "message_received", "gauges", "Number of messages received by the publish API");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::MessageSent,"message_sent", "gauges", "Number of messages sent to clients");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRequestReceived, "number_of_ws_request_received", "gauges", "Number of ws requests received");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numWsConnect, "number_of_ws_connection_received", "gauges", "Number of ws sconcurrent connections");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numMessageSent, "number_of_ws_message_sent", "gauges", "Number of ws message sent");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcAuthor, "number_of_group_author", "gauges", "Number of ws JSON-RPC author method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcBabe, "number_of_group_babe", "gauges", "Number of ws JSON-RPC babe method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcBeefy, "number_of_group_beefy", "gauges", "Number of ws JSON-RPC beefy method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcChain, "number_of_group_chain", "gauges", "Number of ws JSON-RPC chain method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcChildState, "number_of_group_childstate", "gauges", "Number of ws JSON-RPC childstate method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcContracts, "number_of_group_contracts", "gauges", "Number of ws JSON-RPC contracts method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcDev, "number_of_group_dev", "gauges", "Number of ws JSON-RPC dev method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcEngine, "number_of_group_engine", "gauges", "Number of ws JSON-RPC engine method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcEth, "number_of_group_eth", "gauges", "Number of ws JSON-RPC eth method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcNet, "number_of_group_eth/net", "gauges", "Number of ws JSON-RPC eth/net method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcWeb3, "number_of_group_eth/web3", "gauges", "Number of ws JSON-RPC eth/web3 method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcGrandpa, "number_of_group_grandpa", "gauges", "Number of ws JSON-RPC grandpa method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcMmr, "number_of_group_mmr", "gauges", "Number of ws JSON-RPC mmr method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcOffchain, "number_of_group_offchain", "gauges", "Number of ws JSON-RPC offchain method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcPayment, "number_of_group_paymenet", "gauges", "Number of ws JSON-RPC payment method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcRpc, "number_of_group_rpc", "gauges", "Number of ws JSON-RPC rpc method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcState, "number_of_group_state", "gauges", "Number of ws JSON-RPC state method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcSyncstate, "number_of_group_syncstate", "gauges", "Number of ws JSON-RPC syncstate method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcSystem, "number_of_group_system", "gauges", "Number of ws JSON-RPC system method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRpcSubscribe, "number_of_group_subscribe", "gauges", "Number of ws JSON-RPC subscribe method group");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numCacheInsert, "number_of_cache_insert", "gauges", "Number of ws Cache insert event");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numCacheHit, "number_of_cache_hit", "gauges", "Number of ws Cache hit event");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numCacheLookup, "number_of_cache_lookup", "gauges", "Number of ws Cache lookup event");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numCacheExpiry, "number_of_cache_expiry", "gauges", "Number of ws Cache expiry event");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numRequestMultiPart, "number_of_cache_request_multi_part", "gauges", "Number of ws Cache multi-part request");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numSubscriptionInsert, "number_of_subscription_insert", "gauges", "Number of ws Subscripion insert event");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numSubscriptionHit, "number_of_subscription_hit", "gauges", "Number of ws Subscripion hit event");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numSubscriptionLookup, "number_of_subscription_lookup", "gauges", "Number of ws Subscripion lookup event");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numSubscriptionExpiry, "number_of_subscription_expiry", "gauges", "Number of ws Subscripion expiry event");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numResponseMultiPart, "number_of_cache_response_multi_part", "gauges", "Number of ws Subscripion multi-part response");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numCacheItem, "number_of_cache_item", "gauges", "Number of ws Cache items");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numSubscriptionItem, "number_of_subscription_item", "gauges", "Number of ws Subscription items");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numAutoRefreshItem, "number_of_cache_auto_refresh_item", "gauges", "Number of ws Auto-Refresh items");
		prometheusMetrics += PrometheusMetric(PrometheusMetric::numAREItemCount, "number_of_cache_auto_refresh_exception_item", "gauges", "Number of ws Auto-Refresh Exception items");
		// Group count add
		...
		for (int i = 0; i < gCnt; i++)
		{
			...
			prometheusMetrics += PrometheusMetric(groupType, groupName, "gauges", groupName);	
		}
		shmdt(shm_str);
